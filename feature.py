...
print("="*60)
print("BASELINE MODEL (All 7 Features)")
print("="*60)
...
# Features with < 5% importance are likely redundant
...
feature_sets = {
    ...
    # Core features only (top 3 by importance)
...
# ==========================================
# STEP 5: Recommend optimal feature set
# ==========================================
...
if len(candidates) > 0:
    ...
    print("\n⚠️  All simplified models lose >2% performance")
    print("   Recommend keeping full feature set")
    recommended_features = feature_columns_full

# ==========================================
# STEP 6: Visualize feature selection
# ==========================================
...
# ==========================================
# STEP 7: Save recommended model
# ==========================================

print("\n" + "="*60)
print("TRAINING FINAL SIMPLIFIED MODEL")
print("="*60)
...
# Feature importance of simplified model
